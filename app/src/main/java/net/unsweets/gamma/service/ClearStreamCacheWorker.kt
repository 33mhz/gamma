...
class ClearStreamCacheWorker(context: Context, params: WorkerParameters) :
    ...
    class Receiver(val listener: Listener) : android.content.BroadcastReceiver() {
        interface Listener {
    ...
    companion object {
        ...
        private const val action = "net.unsweets.gamma.service.ClearStreamCacheService"
        val intentFilter = android.content.IntentFilter(action)
    }
}
